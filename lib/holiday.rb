  ...
  holiday_hash.each do |season, holiday|
    ...
    holiday.each do |holiday_name, supplies|
      ...
      if holiday_name.to_s.include?("_")
        holiday_name = holiday_name.to_s.gsub(/[_]/, " ")
        holiday_name = holiday_name.split(" ").collect{ |string| string.capitalize}.join(" ")
      else
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.collect{|season, holiday| holiday_hash[season].keys.select{|holiday| holiday_hash[season][holiday].include?("BBQ") }}.flatten
end